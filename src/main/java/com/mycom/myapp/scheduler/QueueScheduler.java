...
import com.mycom.myapp.service.ActiveUserService;
...
public class QueueScheduler {
    ...
    public void processQueue() {
        activeUserService.popRandomActiveUsers();
        ...
        List<String> movedUsers = waitingQueueService.moveTopNUsersToActiveQueue(possibleActiveCount);
